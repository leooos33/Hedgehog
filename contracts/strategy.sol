...
<<<<<<< HEAD
       @param _poolEthOsqth osqth:eth uniswap pool address
       @param _oracle oracle address
=======
       @param _poolEthOsqth eth:osqth uniswap pool address
       @param _oracle oracle address 
>>>>>>> df323cbb3aab822f61b21762b56e21ba417b0f86
...
<<<<<<< HEAD
        osqth = IERC20(IUniswapV3Pool(_poolEthOsqth).token0);
=======
...
>>>>>>> df323cbb3aab822f61b21762b56e21ba417b0f86
        ...
        )
    {
        ...
        //send tokens to user
<<<<<<< HEAD
        if (amountEth > 0) weth.transfe(msg.sender, amountEth);
        if (amountUsdc > 0) usdc.transfer(msg.sender, amountUsdc);
        if (amountOsqth > 0) osqth.tranfer(msg.sender, amountOsqth);
=======
...
<<<<<<< HEAD
            usdc.transferFrom(keeper, address(this), _deltaUsdc);
=======
            usdc.transferFrom(keeper, address(this), _deltaUsdc);
>>>>>>> df323cbb3aab822f61b21762b56e21ba417b0f86
