...
const _calcSharesAndAmounts = (params) => {
    let depositorValue = params._amountOsqth
        .mul(params.ethUsdcPrice)
        .mul(params.osqthEthPrice)
        .div(e36)
        .add(params._amountUsdc.mul(e12))
        .add(params._amountEth.mul(params.ethUsdcPrice).div(e18));
    ...
    if (params.totalSupply == 0) {
        return [
            ...
            depositorValue.mul(targetOsqthShare.div(e18)).div(params.osqthEthPrice.mul(params.ethUsdcPrice)),
        ];
    } else {
